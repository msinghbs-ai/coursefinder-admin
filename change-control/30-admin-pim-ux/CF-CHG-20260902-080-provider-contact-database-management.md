...
CF-080 adds a managed PIM registry/workspace above those source observations so operators can curate a stable logical contact record without rewriting historical Evidence.
...
11. **Search/Website/Zoho admission is unchanged.** No consumer publication is authorised by CF-080.

## Implemented logical data model
