...
>
> **M2.4.5:** ACTIVE under `CF-CHG-20260903-087`. H1 Administration IA/UI standardisation is IMPLEMENTED / TARGETED PASS under `CF-CHG-20260903-088` (build `33700864619`, deployed UAT `33700864824`). H2 Scraper Config/routing hardening is ACTIVE under CF-085/CF-087. M2.4.4 remains CLOSED/PASS/FROZEN. No Production Supabase project exists.
>
...
- Current database architecture: `docs/coursefinder-database-architecture-v2.10.50.md` plus closed prior Change Controls;
- Admin/PIM design decisions: `docs/coursefinder-admin-pim-design-decisions-v1.31.md`;
...
| CF-CHG-20260903-087 | 00-governance-programme | M2.4.5 Admin/PIM Hardening & Pre-Production Operational Readiness | ACTIVE / H2 | `00-governance-programme/CF-CHG-20260903-087-m2-4-5-admin-pim-hardening-preproduction-readiness.md` |
