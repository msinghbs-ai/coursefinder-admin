...
| CF-CHG-20260902-068 | 20-layer1-regulatory-ingestion | QS Direct XHR / JSON Layer 1 Acquisition Qualification | IMPLEMENTED / DEPLOYED UAT ACTIVE | `20-layer1-regulatory-ingestion/CF-CHG-20260902-068-qs-direct-xhr-json-layer1-acquisition.md` |
...
- Admin/PIM design decisions: `docs/coursefinder-admin-pim-design-decisions-v1.27.md`;
- Admin navigation / information architecture: `docs/coursefinder-admin-navigation-information-architecture-v1.5.md`;
