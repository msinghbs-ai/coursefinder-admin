...
- current Master Project Plan: `docs/coursefinder-master-project-plan-v1.56.md`;
- current Running Build: `docs/coursefinder-running-build-v2.59.md`;
- current architecture: `docs/coursefinder-database-architecture-v2.10.38.md`;
- current Admin operating guide: `docs/coursefinder-pim-admin-guide-v1.10.md`;
...
- current browser read boundary: `public.admin_read(text,jsonb)` with Pipeline Operator rank 4 for Pipeline Control / Jobs / Sources;
- final Pipeline Evidence entity-impact optimisation: `20260820235820 — m1_pipeline_ops_evidence_entity_links_fast_v2`;
- no generic retry/replay/reset mutation is authorised by this acceptance;
- current live stale/blocked jobs remain owning-adapter operational work, not permission for destructive replay/reset.
