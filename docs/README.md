...
| Platform Design Reference (single decision authority) | `docs/coursefinder-design-reference-v1.2.md` | CURRENT |
| Platform Design Reference v1.1 | `docs/coursefinder-design-reference-v1.1.md` | HISTORY — see v1.2 |
| Platform Design Reference v1.0 | `docs/coursefinder-design-reference-v1.0.md` | HISTORY — see v1.2 |
