...
| Platform Design Reference (single decision authority) | `docs/coursefinder-design-reference-v1.1.md` | CURRENT |
| Platform Design Reference v1.0 | `docs/coursefinder-design-reference-v1.0.md` | HISTORY — see v1.1 |
