# CourseFinder Database Architecture v2.10.43

**Status:** CURRENT — M2.4.2 ACCEPTED ADDITIVE ARCHITECTURE  
**Date:** 29 August 2026  
**Supersedes:** v2.10.42; all unspecified prior structures and semantics remain inherited unchanged.  
**Change Controls:** `CF-CHG-20260823-029`, `CF-CHG-20260827-044`
