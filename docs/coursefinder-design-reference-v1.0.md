# CourseFinder Platform Design Reference v1.0
...
**Replaces as the decision authority:** Admin/PIM Design Decisions v1.0–v1.36 and the Attribute & Admission Register v1.0 (kept as history)  
...
| R10 | Automation acts under a real admin's identity | `layer2_automation_actor()` returns the first Platform Admin | Create a system identity for automation (Decision 150, proposed) |
...
| Item | Status |
|---|---|
| Decision 149 — country-neutral identity and consumer fields | Proposed |
| Decision 150 — system identity for automation | Proposed |
| Refinements R1–R13 | To schedule |
...
**Status:** Proposed · **Recorded in:** this reference (26 September 2026)
...
Automated actions are recorded under a dedicated system identity, not a person's account. layer2_automation_actor() currently returns the first Platform Admin, so automated submissions carry a real person's identity; until the system identity exists, automated records also carry origin 'automatic'.
