# CourseFinder Platform Design Reference v1.2
...
**Supersedes:** Design Reference v1.1 (the single decision authority since 26 September 2026; earlier versions, Design Decisions v1.0–v1.36 and the Attribute & Admission Register v1.0 are history)  
...
| R16 | Register ingestion overdue | CRICOS and NZQA next ingestion has been due since 2 Sep 2026; weekly runs only verified | Investigate first in Package 9; a catch-up ingest is safe now that Layer 1 writes only on change |
...
| Refinements R1–R9, R11–R14, R16, R17 | To schedule (R10 and R15 done) |
