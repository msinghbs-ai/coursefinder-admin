# CourseFinder Operations Runbook v1.6

**Status:** CURRENT M2.4 OPERATIONS RUNBOOK  
**Date:** 28 August 2026  
**Supersedes:** `docs/coursefinder-operations-runbook-v1.5.md`  
**Change Controls:** existing M2 controls plus `CF-CHG-20260826-043` and `CF-CHG-20260827-044`
