# CourseFinder PIM Admin Guide v1.21

**Status:** CURRENT M2.4 ADMIN GUIDE  
**Date:** 26 August 2026  
**Supersedes:** `docs/coursefinder-pim-admin-guide-v1.20.md`  
**Change Controls:** prior accepted M2 controls plus `CF-CHG-20260826-043`
