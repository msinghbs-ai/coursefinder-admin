...
|---|---|---|---|---|
| M245-FU-032 | H4 / CF-CHG-20260910-093 | Scheduled Tasks operator maturity + governed AU Course Facts target builder | REOPENED / CORRECTIVE GATE | Deployed baseline remains PR #69 / v2.15.78 at `cfc4702ba57a58ea31936dcabbd96fdd765194e2`. Corrective PR #71 exact head `00c98f0cea22e8ef2d8f12adb16a1e6cc5e3f575`; latest immutable runtime migration `20260911120131 cf_093_scheduler_operator_reason_and_route_chain_finalizer`; Frontend Build `34597632959` PASS; exact-head Codex review clean in comment `5634309865`; Security Advisor remains 191 INFO / 0 WARN / 0 ERROR. Remaining blocker: no genuinely governed policy-qualified fully queueable AU University target exists for required consequential acceptance—Nova and Stamford are fully queueable but each has execution-policy gap 1; UQ/State scopes require fail-closed async discovery. Do not manufacture policy/configuration or weaken Preview/authority for UAT. Keep generic discovery/L3/L4/Evidence reprocess/Search/Publication and recurring country/state disabled. |
