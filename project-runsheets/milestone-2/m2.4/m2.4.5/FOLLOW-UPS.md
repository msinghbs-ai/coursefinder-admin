...
|---|---|---|---|---|
| M245-FU-032 | H4 / CF-CHG-20260910-093 | Scheduled Tasks operator maturity + governed AU Course Facts target builder | REOPENED / CORRECTIVE GATE | PR #69 merged as `85bc068d379ed3fc9231d167cf524e56419e80f9` and v2.15.78 release baseline is `cfc4702ba57a58ea31936dcabbd96fdd765194e2`, but five post-merge Codex P2 findings require forward reconciliation. Pilot runtime `20260911085724 cf_093_scheduler_postmerge_codex_finalizer` applied; corrective PR #71 exact head `a24f36b3e701391ab509c8c86c3820e02e234c9a`; exact-head Codex/CI/targeted acceptance pending. Keep generic L3/L4, Evidence reprocess, Search/Publication effects and recurring country/state construction disabled. |
