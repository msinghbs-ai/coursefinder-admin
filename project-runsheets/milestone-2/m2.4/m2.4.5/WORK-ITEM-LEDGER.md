...
| 2026-09-04 06:25 | FEATURE/HARDENING | Finish H11 university Provider logo completeness using first-party assets plus governed Hotcourses/public fallback where required | H11 | CF-CHG-20260903-101 | Pilot migrations/Edge hardening; 49/49 primary assets; UAT spec `9f65736f...`; routing `94d10f5e...` | runtime DB acceptance PASS; build `33802561372` PASS; deployed UAT `33802561541` PASS | CLOSED / PASS |
| 2026-09-04 07:02 | FEATURE/HARDENING | Display approved university logos in Provider/Course blades and comparison; make Hotcourses AU/NZ directory a repeatable Layer 2 Provider Asset reconciliation feed | H11 follow-through / UI | CF-CHG-20260904-102 | Admin v2.15.57; private signed logo access; Hotcourses AU/NZ Evidence + parser; Pilot head `d947f693...` | runtime/data PASS; build `33805770000` PASS; deployed UAT `33805769747` PASS | CLOSED / PASS |

| 2026-09-10 21:19 | OPERATIONS | Scheduled Tasks configuration and governed run control | H4 | CF-CHG-20260910-092 | Pilot `9305eb3a004d12724ec26b6bab65e1d4b1ab2239`; v2.15.76 | preview 34468684736; deployed 34470101936 attempt 2 PASS | CLOSED / PASS |
