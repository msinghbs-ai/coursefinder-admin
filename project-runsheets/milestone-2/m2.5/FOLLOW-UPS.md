...
| M25-FU-016 | Layer 3 source-pattern operator execution | CF-054 backend/Edge/manual queue implemented; legacy HTTP→HTTPS same-host hand-back reconciled; rollback paths PASS; live manual queue is 422 and was not bulk drained | Run post-09:25 targeted source contract; after FU-015 deployment reconciliation browser-prove v2.15.17 queue; real operator canary remains separately bounded | IMPLEMENTED / SOURCE+ROLLBACK PASS / TARGETED CI PENDING / DEPLOYED UI BLOCKED |
