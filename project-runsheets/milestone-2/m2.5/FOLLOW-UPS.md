...
| M25-FU-009 | Evidence Storage lineage mismatch | CF-055 classifies 205 raw unlinked objects as 200 proven duplicates + 5 unresolved; 18 missing-path rows as 16 virtual URI references + 2 real legacy missing bucket paths | Keep all historical objects/rows retained; resolve 5+2 provenance separately. Forward duplicate prevention is deployed; check CF-055 targeted trigger `ca1e54f9...` | CLASSIFIED / WARNING / PREVENTION IMPLEMENTED / REMEDIATION OPEN |
