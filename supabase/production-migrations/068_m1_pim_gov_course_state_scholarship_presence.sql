-- M1-PIM-GOV Course state Scholarship-presence correction v1
-- Applied to coursefinder_Pilot as m1_pim_gov_course_state_scholarship_presence_v1.
-- Scholarship relationship presence is useful for canonical-vs-Search admission
-- comparison but is deliberately outside the six-signal Admin readiness score.
...
begin
  ...
  return jsonb_build_object(
    ...
    'canonical_presence',jsonb_build_object(
      'scholarship',coalesce((v_item->>'has_scholarship')::boolean,false)
    ),
